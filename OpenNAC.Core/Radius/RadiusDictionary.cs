...
namespace OpenNAC.Core.Radius
{
    public class RadiusDictionary : IRadiusDictionary
    {
        ...
        public IDictionary<byte, DictionaryAttribute> GetAttributes()
        {
            return Attributes;
        }

        public IDictionary<string, DictionaryAttribute> GetAttributeNames()
        {
            return AttributeNames;
        }

        public List<DictionaryVendorAttribute> GetVendorSpecificAttributes()
        {
